...
class TilePuzzleGUI(tkinter.Frame):
    ...
    def __init__(self, master, rows, cols):
        ...
        self.rows = rows
        self.cols = cols
        self.puzzle = homework.create_tile_puzzle(rows, cols)
    ...
    def solve_iddfs_click(self):
        self.board.animate_moves(next(self.puzzle.get_solutions_iddfs()))

    def solve_a_star_click(self):
        self.board.animate_moves(self.puzzle.get_solution_A_star())
